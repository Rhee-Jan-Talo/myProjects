...
#    path('generate_pdf/' , prof_views.generate_pdf, name='generate_pdf'),
    ...
    path('generate_pdf_profit/<date>' , prof_views.generate_pdf_profit, name='generate_pdf_profit'),
...
#    path('edit_additional_appointment_info/ <primary_key>' , prof_views.edit_additional_appointment_info, name='edit_additional_appointment_info'),
    path('make_payment/<appointment_id>/<service_fee>/<procedures_fee>/<tools_fee>/<discount>' , prof_views.make_payment, name='make_payment'),
...
#    path('edit_bills' , prof_views.edit_bills, name='edit_bills'),
    ...
    path('add_new_item/<itemname>/<barcode>/<itemcategory>/<location>/<item_fee>/<quantity>/<units>/<srp>' , prof_views.add_new_item, name='add_new_item'),
    path('add_nonperishableList' , prof_views.add_nonperishableList, name='add_nonperishableList'),
    path('add_perishableList/<itemname>/<barcode>/<itemcategory>/<location>/<item_fee>/<quantity>/<units>/<expiry_date>/<srp>' , prof_views.add_perishableList, name='add_perishableList'),
...
#    path('view_inventory_filter/<order>' , prof_views.view_inventory_filter, name='view_inventory_filter'),
    ...
    path('profit_breakdown/<date>' , prof_views.profit_breakdown, name='profit_breakdown'),
    #path('profit_breakdown_pdf/<date>' , prof_views.profit_breakdown_pdf, name='profit_breakdown_pdf'),
