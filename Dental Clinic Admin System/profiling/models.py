...
class item_inventory(models.Model):
    ...
    tot_quan = models.IntegerField(default = 0)
    tot_amount = models.DecimalField(max_digits = 10, decimal_places = 2, default = 0)
    tot_spent = models.DecimalField(max_digits = 10, decimal_places = 2, default = 0)
    srp = models.DecimalField(max_digits = 10, decimal_places = 2, default = 0)
...
#    schedule_id (P)
    ...
    etime = models.TimeField(auto_now=False, auto_now_add =False, null = True)
...
#    appointment_id(P)
    ...
    def get_html_url(self):
        ...
        return f'<a class="cal_data" href="{url}"> <span style="display: block;"><b>Patient:</b> {self.patient_id.fullname}</span> <span style="display: block;"> <b>Start Time:</b> {self.schedule_id.time }</span> <span style="display: block;"> <b>End Time:</b> {self.schedule_id.etime }</span> <span style="display: block;"><b>Status:</b> {self.appointment_status}</span> <br></br> </a>'
...
#    payment_id (P)
    ...
    total_tools_fee = models.DecimalField(max_digits = 10, decimal_places= 2, default = 0)
